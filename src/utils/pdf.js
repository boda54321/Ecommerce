...
function generateHeader(doc) {
    doc
        .image("arkan.png", 50, 45, { width: 50 })
        .fillColor("#444444")
        .fontSize(20)
        .text("arkan Store", 110, 57)
        .fontSize(10)
        .text("arkan", 200, 50, { align: "right" })
        .text("88haron", 200, 65, { align: "right" })
        .text("Egypt, nasercity, 2000", 200, 80, { align: "right" })
        .moveDown();
}
